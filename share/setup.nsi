...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/nvidiacoin-qt.exe
    File /oname=COPYING.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/nvidiacoind.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Quark.lnk" $INSTDIR\nvidiacoin-qt.exe
    ...
    WriteRegStr HKCR "quark" "" "URL:nVidiaCoin"
    WriteRegStr HKCR "quark\DefaultIcon" "" $INSTDIR\nvidiacoin-qt.exe
    WriteRegStr HKCR "quark\shell\open\command" "" '"$INSTDIR\nvidiacoin-qt.exe" "%1"'
SectionEnd
