...
const string strMessageMagic = "nVidiaCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000a4239a34226d32a47f6cb28c27410194048b33a9f0c21f062fe64368ebe");
    }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "Feb 20 2016,Minedowns Development team.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x1ee900be8c00170e5f510fd97fab21544f77670966d025fdbd5505cad025ea91"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("nVidiaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("nVidiaCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("nVidiaCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("nvidiacoin-miner");
    ...
    try { loop {
        ...
        printf("Running nVidiaCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("nVidiaCoinMiner terminated\n");
        throw;
    }
}
